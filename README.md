...
**검증 (2025 시즌 walk-forward):** 특정 시점 추정치가 그 이후 실제 잔여 타율을 얼마나 잘 예측하는지를 log loss / Brier로 평가하고, 항상 베이스라인(관측 타율)과 비교한다. 6개 시점 모두에서 베이지안이 베이스라인을 앞섰고, 우월폭은 시즌 초에 크고 후반으로 갈수록 좁혀졌다.
